...
public class AndroidPushNotificationService {
    ...
    /*firebase에서 복사한 서버키*/
    private static final String firebase_server_key = "AAAAnwv2hvE:APA91bGPoq" +
            "-ZsvBGdpyXGTrhSFrnHnX57uU8_s9BwrLki8nJ84_TMd_DJ3gRkOH" +
            "-0pdlmRuDjxWOI7zhQPeBSZBIYk6adxWWGbRrH4GUwGqJkF9RdyWFaEKdREot0KhqshMEkWarMMnI";
 ...
 *   가정했을 때 로그인이나 계정의 권한과 같은 처리는 인터셉터를 사용해서 처리합니다.
 * */